...
%	\vfill
%	\includegraphics[height=7cm,width=7cm]{logo}\\
	
%	\vfill % Position the date 3/4 down the remaining page
	%{\large\today} % Date, change the \today to a set date if you want to be precise
	
%	\textsc{\LARGE Govt. Model Engineering College}\\[1.5cm] % Main heading such as the name of your university/college
	
%	\textsc{\Large Seminar Report}\\[0.5cm] % Major heading such as course name
	
%	\textsc{\large Department of Electronics and Communication Engineering}\\[0.5cm] % Minor heading such as course title
...
%	\HRule\\[1.5cm]
	...
	%	Author(s)
	%------------------------------------------------
%	\textsc{\Large Submitted By}\\[0.4cm]
%	\textsc{\Large P H Aju}\\[0.5cm]
